...
void drawAxes(float l, float w)
{
	...
	glBegin(GL_LINES);
	glColor3f(35, 0, 0); glVertex3f(0, 0, 0); glVertex3f(35, 0, 0); // x-axis
	glColor3f(0, 35, 0); glVertex3f(0, 0, 0); glVertex3f(0, 35, 0); // y-axis
	glColor3f(0, 0, 35); glVertex3f(0, 0, 0); glVertex3f(0, 0, 35); // z-axis
	glEnd();
}

...
public class PortalTraveller : MonoBehaviour {
    ...
    public virtual void Teleport (Transform fromPortal, Transform toPortal, Vector3 pos, Quaternion rot) {
        ...
        UnityStandardAssets.Characters.FirstPerson.FirstPersonController fpsC = this.gameObject.GetComponent<UnityStandardAssets.Characters.FirstPerson.FirstPersonController>();
